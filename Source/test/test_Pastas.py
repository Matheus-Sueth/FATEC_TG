...
@fixture
def pasta_valida_fora_bd2():
    return Pasta(0, 0, r'D:/Filmes', r'G:/imagens', r'E:\Matheus\Arquivos\Linguagens\Python\tg\Source\banco_testes.db')
...
class TestClassPastas:
    ...
    class TestClassPastasValidation:
        ...
        def test_quando_programa_validar_pastas_recebe_pasta_deve_retornar_exception_imagem(self, pasta_failure_imagem):
            ...
            assert f'Diretório de imagens({pasta_failure_imagem.caminho_imagem}) não foi encontrado' in str(erro.value)
        ...
        def test_quando_programa_validar_pastas_recebe_pasta_deve_retornar_exception_filme(self, pasta_failure_filme):
            ...
            assert f'Diretório de filmes({pasta_failure_filme.caminho_filme}) não foi encontrado' in str(erro.value)
    ...
    class TestClassPastasUpdate:
        ...
        @mark.parametrize("pasta_antiga,pasta_nova", [
            (Pasta(0, 9, r'D:/Filmes', r'G:/imagens', r'E:\Matheus\Arquivos\Linguagens\Python\tg\Source\banco_testes.db'), Pasta(0, 0, r'D:/Filmes', r'G:/imagem', r'E:\Matheus\Arquivos\Linguagens\Python\tg\Source\banco_testes.db')),
            (Pasta(0, 0, r'D:/Filmes', r'G:/imagem', r'E:\Matheus\Arquivos\Linguagens\Python\tg\Source\banco_testes.db'), Pasta(0, 9, r'D:/Filmes', r'G:/imagens', r'E:\Matheus\Arquivos\Linguagens\Python\tg\Source\banco_testes.db'))
        ])
        def test_quando_programa_altera_pastas_usuario_recebe_pastas_deve_retornar_true(self, pasta_antiga, pasta_nova, usuario_dentro_bd):
            assert banco_pastas.alterar_pastas(pasta_antiga, pasta_nova, usuario_dentro_bd)
        ...
        def test_quando_programa_cria_pastas_usuario_recebe_pasta_deve_retornar_exception_pasta_existe(self, pasta_valida_dentro_bd, pasta_valida_fora_bd, usuario_fora_bd):
            with raises(Exception) as erro:
        ...
        def test_quando_programa_cria_pastas_usuario_recebe_pasta_deve_retornar_exception_imagem_existe(self, pasta_valida_dentro_bd, usuario_fora_bd):
            with raises(Exception) as erro:
                banco_pastas.alterar_pastas(pasta_valida_dentro_bd, pasta_valida_dentro_bd, usuario_dentro_bd)
            assert 'Essa pasta de imagem já existe no banco de dados' in str(erro.value)

    @mark.delete_folders
    class TestClassUsuarioDelete:
        @mark.delete_folders_success
        def test_quando_programa_deleta_usuario_recebe_dados_usuario_deve_retornar_true(self, pasta_valida_fora_bd, usuario_dentro_bd):
            assert banco_pastas.deletar_pastas(pasta_valida_fora_bd, usuario_dentro_bd)

        @mark.delete_folders_failure_folder_not_existing
        def test_quando_programa_cria_pastas_usuario_recebe_pasta_deve_retornar_exception_pasta_nao_existe(self, pasta_valida_fora_bd, usuario_fora_bd):
            with raises(Exception) as erro:
                banco_pastas.deletar_pastas(pasta_valida_fora_bd, usuario_fora_bd)
            assert f'Nenhuma pasta foi encontrada para o usuário {usuario_fora_bd.nome}' in str(erro.value)